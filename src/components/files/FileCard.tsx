        ...
        >
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex flex-wrap items-center gap-2 text-sm text-gray-600">
              <span
                className={`inline-flex items-center gap-1 px-2 py-1 rounded-full text-xs font-semibold ${getFolderBadgeColor(file.folder)}`}
              >
    ...
    >
      ...
      <div className="aspect-video bg-gray-100 relative overflow-hidden">
        ...
        <div className="absolute top-3 right-3">
          <span className="inline-flex items-center gap-1 rounded-full bg-white/90 px-2 py-1 text-xs font-semibold text-emerald-700 backdrop-blur-sm">
            {isImage ? (
      ...
      <div className="p-4">
        ...
        <div className="mb-4 flex items-center justify-between text-xs text-gray-500">
          <span className="truncate font-mono">{file.uuid}</span>
          <span className="flex items-center gap-1">
            <FaCalendar className="w-3 h-3" />
            {new Date(file.updated_at).toLocaleDateString("id-ID")}
          </span>
