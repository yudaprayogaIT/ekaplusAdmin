...
import { FaBuilding, FaEye, FaClock, FaCheckCircle, FaBan } from "react-icons/fa";
...
export function GPCard({ gp, onViewDetails }: GPCardProps) {
  return (
    <motion.div
    ...
    >
      ...
      <div className="p-5 space-y-4">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-600">
          ...
          <span>
            Created: {new Date(gp.created_at).toLocaleDateString("id-ID", {
              day: "numeric",
              month: "short",
              year: "numeric",
            })}
        ...
        {gp.created_by && (
          <div className="text-sm text-gray-500">
            By: <span className="font-medium text-gray-700">{gp.created_by}</span>
          </div>
        )}
