...
function HotDealsSection({ products }: { products: Product[] }) {
  ...
  return (
    <motion.div
      ...
      className="bg-gradient-to-r from-red-500 via-orange-600 to-amber-600 rounded-2xl p-6 text-white relative overflow-hidden"
    >
      {/* Background Pattern */}
    ...
    <div className="space-y-6">
      ...
      >
        ...
        <div className="flex items-center gap-2 text-sm text-gray-500">
          ...
          <span>Overview data ekaplus Anda</span>
        </div>
      </motion.div>
