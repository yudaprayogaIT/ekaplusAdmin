...
function UserMenu() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "UserMenu.useEffect": ()=>{
            if (!isAuthenticated || isLoading || ("TURBOPACK compile-time value", "object") === "undefined" || !PROFILE_FEATURE_TOUR_DEBUG && window.localStorage.getItem(PROFILE_FEATURE_TOUR_KEY) || window.sessionStorage.getItem(PROFILE_FEATURE_TOUR_PENDING_KEY) !== "menu") {
                return;
            }
    ...
    const acknowledgeProfileCoachmark = ()=>{
        if ("TURBOPACK compile-time truthy", 1) {
            window.localStorage.setItem(PROFILE_FEATURE_TOUR_KEY, "seen");
            window.sessionStorage.removeItem(PROFILE_FEATURE_TOUR_PENDING_KEY);
        }
        setShowProfileCoachmark(false);
    };
    const handleProfileClick = ()=>{
        if ("TURBOPACK compile-time truthy", 1) {
            window.sessionStorage.setItem(PROFILE_FEATURE_TOUR_PENDING_KEY, "edit");
        }
        setShowProfileCoachmark(false);
        router.push("/profile");
    };
...
//# sourceMappingURL=src_d88ed26a._.js.map