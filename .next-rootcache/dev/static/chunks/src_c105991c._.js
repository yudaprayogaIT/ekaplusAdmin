...
_s(LoginForm, "wc6bXTTlq4KfV2NryWtLMPWHvfE=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"]
    ];
});
...
"[project]/src/lib/driverTour.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function createDriverTour(config) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$driver$2e$js$2f$dist$2f$driver$2e$js$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["driver"])({
        animate: true,
        allowClose: true,
        ...
        onPopoverRender: (popover, opts)=>{
            ...
            opts.config.onPopoverRender?.(popover, opts);
        },
        ...config
    });
}
...
function UserMenu() {
    ...
    const driverRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const continuingTourRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(false);
        ...
        "UserMenu.useEffect": ()=>{
            ...
            const timer = window.setTimeout({
                "UserMenu.useEffect.timer": ()=>{
                    ...
                    const driverObj = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$driverTour$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createDriverTour"])({
                        showButtons: [
                            "next",
                            "close"
                        ],
                        overlayClickBehavior: {
                            "UserMenu.useEffect.timer.driverObj": ()=>{
                                continuingTourRef.current = false;
                        ...
                        steps: [
                            {
                                element: button,
                                popover: {
                                    title: "Apa yang baru di halaman profile?",
                                    description: "Sekarang user bisa edit profil, edit foto profil, dan reset password langsung dari halaman profile.",
                                    side: "left",
                                    align: "center",
                                    nextBtnText: "Buka Profile",
                                    onNextClick: {
                                        "UserMenu.useEffect.timer.driverObj": ()=>{
                                            ...
                                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$featureTour$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setPendingFeatureTourStep"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$featureTour$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["profileFeatureTourConfig"], "edit");
                                            driverRef.current?.destroy();
                                            router.push("/profile");
                                        }
                                    }["UserMenu.useEffect.timer.driverObj"],
...
_s(UserMenu, "NzE1QbuPK3WqFtJSgT/2K9ef2jk=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
...
//# sourceMappingURL=src_c105991c._.js.map