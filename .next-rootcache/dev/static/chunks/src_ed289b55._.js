...
"[project]/src/utils/paymentAccount.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function fetchBranchConnectionInfo(branchId, authToken) {
    ...
    const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiFetch"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getQueryUrl"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_CONFIG"].ENDPOINTS.BRANCH, spec), {
        method: "GET",
        cache: "no-store"
    }, authToken);
    if (!response.ok) {
...
"[project]/src/utils/filterUtils.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/types/customerRegistration.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useFilters(options) {
    ...
    const [filters, setFiltersInternal] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(initialFilters || []);
    ...
    const onFiltersChangeRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(onFiltersChange);
    // // Debug logging
    // useEffect(() => {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useFilters.useEffect": ()=>{
            if (("TURBOPACK compile-time value", "object") === "undefined" || initialized) return;
            ...
            if (filterParam) {
                ...
                loadedFilters = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$filterUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["urlParamToFilters"])(filterParam);
            } else {
                // Load from localStorage (fallback)
                loadedFilters = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$filterUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loadFiltersFromStorage"])(entity);
            }
    ...
    const setFilters = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useFilters.useCallback[setFilters]": (newFilters)=>{
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$filterUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["saveFiltersToStorage"])(entity, newFilters);
            // Update URL params
            if ("TURBOPACK compile-time truthy", 1) {
                const url = new URL(window.location.href);
                if (newFilters.length > 0) {
                    url.searchParams.set("filters", (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$filterUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["filtersToUrlParam"])(newFilters));
                } else {
    ...
    const clearFilters = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useFilters.useCallback[clearFilters]": ()=>{
            setFilters([]);
        }
    }["useFilters.useCallback[clearFilters]"], [
        setFilters
...
_s(useFilters, "OOcfnDoQivdNfaCaSZSbU4PjX04=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/config/filterFields.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/customerRegistrationApproveTour.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function setPendingCustomerRegistrationApproveTour() {
    ...
    ;
    window.sessionStorage.setItem(CUSTOMER_REGISTRATION_APPROVE_TOUR_PENDING_KEY, "pending");
}
function consumePendingCustomerRegistrationApproveTour() {
    if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
    ;
    const value = window.sessionStorage.getItem(CUSTOMER_REGISTRATION_APPROVE_TOUR_PENDING_KEY);
    if (value !== "pending") return false;
    window.sessionStorage.removeItem(CUSTOMER_REGISTRATION_APPROVE_TOUR_PENDING_KEY);
    return true;
}
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
...
//# sourceMappingURL=src_ed289b55._.js.map